...
def epw_preamble(filehandle):
    ...
    print('LOCATION,%s in %s,%s,AUS,BoM,%s,%.2f,%.2f,%.1f,%.1f' %
          (stname, args.year, ststate, stnumber, locn.lat, locn.lon,
           args.tz, elevation), file=filehandle)
...
def tmy3_record(filehandle, rec):
